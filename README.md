...
-------------
	...
	Начало "Одномерные массивы"
		Чтение файла
		Цикл пока i < (N-1)
		нц
			Если текущий элемент равен нулю, а следующий не равен нулю то
				увеличиваем i на 1
				пропускаем текущую итерацию
			конец если
		
			считаем знаменатель текущей прогрессии
			сохраняем индекс начала прогрессии
			
			Цикл пока i < (N-1) и следующий знаменатель равен текущему
			нц
				увеличиваем i на 1
			кц
		
			считаем длину текущей последовательности
			сохраняем первый элемент текущей последовательности
			вывод текущей последовательности
		
			Если длина текущей последовательности больше длины максимальной то
				сохранить текущую последовательность как максимальную
			конец если
		кц
...
Разработка и отладка программы "ОДНОМЕРНЫЕ МАССИВЫ" успешно завершена. 
Набор тестов считаем полным.
